    ...
    <>
      <div className="relative h-screen bg-cover bg-center" style={{backgroundImage :`url(${hero})`}}>
        <div className='absolute inset-0 bg-black bg-opacity-30 flex flex-col items-center justify-center text-center'>
          <h1 className='animate-fadeIn text-4xl md:text-5xl font-bold text-white mb-4'> Discover new adventures with us </h1>
          <p className='animate-fadeIn text-lg md:text-2xl text-white mb-8'>Explore amazing places at exclusive deals</p>
